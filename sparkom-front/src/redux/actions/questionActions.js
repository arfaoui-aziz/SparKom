...
export const getUserQuestions = (token, userId) => {
  ...
  return (dispatch) => {
    axios
      .get(`http://localhost:8888/api/questions/by/${userId}`, config)
      .then((res) => {
        dispatch({
...
export const getTopicQuestions = (token, topicId) => {
  ...
  return (dispatch) => {
    axios
      .get(`http://localhost:8888/api/questions/byTopic/${topicId}`, config)
      .then((res) => {
        dispatch({
...
export const getAllQuestions = (token) => {
  ...
  return (dispatch) => {
    axios
      .get(`http://localhost:8888/api/questions`, config)
      .then((res) => {
        dispatch({
          type: questionTypes.GET_ALL,
          payload: res.data,
...
export const addQuestion = (token, userId, question) => {
  ...
  return (dispatch) => {
    axios
      .post(`http://localhost:8888/api/question/create/${userId}`, question, config)
      .then((res) => {
        dispatch({
...
export const likeQuestion = (token, userId, questionId) => {
  ...
  return (dispatch) => {
    axios
      .put(`http://localhost:8888/api/question/like`, { userId, questionId }, config)
      .then((res) => {
        dispatch({
...
export const unlikeQuestion = (token, userId, questionId) => {
  ...
  return (dispatch) => {
    axios
      .put(`http://localhost:8888/api/question/unlike`, { userId, questionId }, config)
      .then((res) => {
        dispatch({
          type: questionTypes.LIKE_UNLIKE_QUESTION,
          payload: res.data,
...
export const addComment = (token, userId, questionId, text) => {
  ...
  return (dispatch) => {
    axios
      .put(
        `http://localhost:8888/api/question/comment`,
...
export const deleteComment = (token, userId, questionId, comment) => {
  ...
  return (dispatch) => {
    axios
      .put(
        `http://localhost:8888/api/question/uncomment`,
...
export const deleteQuestion = (token, questionId) => {
  ...
  return (dispatch) => {
    axios
      .delete(`http://localhost:8888/api/question/${questionId}`, config)
      .then((res) => {
        dispatch({
