...
export default function CardForm(props) {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    setShowLoader(true);
    const [res, err] = await queryApi( "cards/AddDueDate/" + props.idc, cardData, "PUT", false);
    if (err) {
      setShowLoader(false);
      setError({
        visible: true,
          ...
          <div class="col col-lg-6 col-md-6 col-sm-12 col-12">
            <div class="form-group label-floating">
              <form className="content" onSubmit={formik.handleSubmit}>
                ...
                <br/>
                {card.Description!=null? (<h8> Current Description : {card.Description}</h8> ): (<h8></h8>)}
            ...
            <div class="form-group label-floating" style={{ float: "right" }}>
              ...
              <div className="form-group date-time-picker label-floating">
                ...
                <MuiPickersUtilsProvider utils={DateFnsUtils}>
                  <div
                    className="form-group label-floating btn btn-smoke "  style={style}
                  ...
                  >
                    <KeyboardDatePicker
                      ...
                      format="MM/dd/yyyy"
                      value={due_date}
                      onChange={(e) => setCardData({ ...cardData, due_date: e })}
                      fullWidth
                    />
                    <button
                    type="submit"
