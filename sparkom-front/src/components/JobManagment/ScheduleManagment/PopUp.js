...
import { addschedule, setErrors } from '../../../store/slices/schedule';
...
function PopUp(props) {
  ...
  */
  var CLIENT_ID = "1093621710306-elegcmtolg6jrv17n2di3bbronme9eti.apps.googleusercontent.com";
  ...
  var SCOPES = "https://www.googleapis.com/auth/calendar.events";
    ...
    const formik = useFormik({
      ...
      onSubmit: async (values) => {
        ...
        values.StartTime=new Date(ssdate.getFullYear(), ssdate.getMonth(), ssdate.getDate(), ssStart.getHours(), ssStart.getMinutes());
        values.EndTime=new Date(ssdate.getFullYear(), ssdate.getMonth(), ssdate.getDate(), ssEnd.getHours(), ssEnd.getMinutes());
        values.Applicant_id=appUser;
        
        const [res, err] = await queryApi("Schedule/", values, "POST", false);
    ...
    return (
      ...
      <div className="modal-dialog window-popup create-event" role="document">
        ...
        />
            ...
            <button className="btn btn-breez btn-lg full-width" type="submit">
              Save RDV
            </button>
          </div>
        </div>
