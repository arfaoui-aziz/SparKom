...
function JobInformation() {
  ...
  const deleteJobEvent = async () => {
    ...
    <ul className="filter-icons">
      <li>
      <a href="#" className="post-category bg-primary">Dalii</a>
    ...
    <h6>Fundación Mosaico Down A.C.
Ciudad de México, Mexico</h6>
    ...
    <div className="post-content-wrap">
      ...
      <div className="post-content">
        ...
        <ol>
            <li>Study and understand the Agenda of the project (the subjects and objectives for each week/session).</li>
            <li>Study and understand the Agenda of the project (the subjects and objectives for each week/session).</li>
            <li>Study and understand the Agenda of the project (the subjects and objectives for each week/session).</li>
            <li>Study and understand the Agenda of the project (the subjects and objectives for each week/session).</li>
        </ol>
